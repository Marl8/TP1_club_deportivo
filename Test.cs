...
internal class Test
{
    public static void Main() { 
        ...
        // Inscribimos al socio en más actividades.
        ...
        // Excede el límite de actividades permitido (3 actividades max.).
        Console.WriteLine($"Número de actividades del socio {club.ListaSocios[0].Nombre} es: {club.ListaSocios[0].Actividades.Count}");
